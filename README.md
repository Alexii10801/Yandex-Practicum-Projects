...
(здесь программы распианы блее детально  [https://disk.yandex.ru/edit/d/XC3NfmYS4N7Pq382E_CyCCPegnqahzm72s0qoIz-cKg6ajJ1VXZCRGpNUQ])
...
| 3. | [Исследование_объявлений_о продаже_квартир — анализ рынка недвижимости](Проект_ЯП_обычные/Проект_ЯП_Исследование_объявлений_о продаже_квартир.ipynb) | Определение рыночной стоимости объектов недвижимости и типичных параметров квартир | Python, Pandas, Matplotlib, Исследовательский анализ, визуализация даннных, предобработка данных |
